...
bool USlowingProjectileTowerCard::PlayCard_Implementation(const FTileCoord& LocationCoord)
{
	...
	{
		SlowingProjectileTower->InitSlowingProjectileTower(ProjectileDamagePackage, AttackSpeed, RangeMetres, ProjectileMesh, EffectToApply);
	} else
	{
...
float USlowingProjectileTowerCard::GetRangeInMetres_Implementation()
{
	return RangeMetres;
}
